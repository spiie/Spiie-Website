  ...
  return (
    <div className="middle home">
      <div className="games">
        ...
        <GameCard name='Cocktail (SOON)' image='https://previews.123rf.com/images/vladvm/vladvm1507/vladvm150701414/42717512-l-ic%C3%B4ne-de-cocktail-boisson-et-partie-symbole-de-l-alcool-.jpg' link="/cocktail"/>
      </div>
    </div>
  )
}
